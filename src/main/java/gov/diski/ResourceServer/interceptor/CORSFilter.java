package gov.diski.ResourceServer.interceptor;
...
public class CORSFilter extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (allowedOrigins.contains(origin)) {
            System.out.println("Origin "+origin+" allowed ip is in clients.properties");
            ...
            System.out.println("Origin " + origin + " ip is not in clients.properties");
            return true;
        }
    }
}
